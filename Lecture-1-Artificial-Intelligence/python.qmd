...
```{python}
phone_book = {"Patrick": "+61412 456 789",
             "Coffee shop": "(02) 1234 4321"}
phone_book["Patrick"]
```

```{python}
phone_book["Coffee shop"] = "+61400 000 000"
phone_book
```
...
numbers = [1, 2, 3, 4, 5, 6]
first_half = get_half_of_list(numbers, False)
second_half = get_half_of_list(first_half)
print(second_half)
```
...
print(f"'first_half' gets broken into {first_half[:len(first_half)//2]} and {first_half[len(first_half)//2:]}")
```
:::
