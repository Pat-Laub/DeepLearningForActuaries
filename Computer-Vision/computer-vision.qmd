...
![Each channel is multiplied separately & then added together.](Glassner/16-19.png)
...
![Typical CNN architecture.](CNN-architecture.png)
...
::: {.content-visible unless-format="revealjs"}
Our NN is working well but still makes occasional errors. Let's see if we can understand why.
:::
...
::: {.content-visible unless-format="revealjs"}
The characters that the NN has the most trouble with tend to be the ones that I have written poorly. The lesson here is that I need to practice and improve writing these characters...
:::
...
![Schematic of the GoogLeNet architecture.](Zhang-googlenet-architecture.png)
...
![Deeper models aren't just better because they have more parameters. ](goodfellow-depth-matters2.png)
...
![Illustration of a residual connection.](residual-connection.png)
