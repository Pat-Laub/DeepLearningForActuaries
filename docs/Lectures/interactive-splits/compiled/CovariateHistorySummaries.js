function CovariateHistorySummaries({
  ...
  oneBasedDevQuarters,
  show = "all"
  // "all" | "summaries" | "row" — split across two slides
}) {
  ...
  const showSummaries = show !== "row";
  const showRow = show !== "summaries";
  ...
  ), /* @__PURE__ */ React.createElement("span", { className: "text-xs text-gray-600 font-mono" }, "Dev Q", dispQ(maxDevQ))), /* @__PURE__ */ React.createElement("div", { className: "text-xs text-gray-700" }, /* @__PURE__ */ React.createElement("span", { className: "font-mono bg-indigo-100 px-1 rounded mr-1" }, "Valuation: Dev Q", dispQ(cutoffDevQ)), /* @__PURE__ */ React.createElement("span", { className: "font-mono bg-gray-100 px-1 rounded" }, cutoffQuarterKey || "-"))), isZeroOutstanding && /* @__PURE__ */ React.createElement("div", { className: "mt-3 p-2 bg-red-50 border border-red-200 rounded text-xs text-red-800" }, "\u26A0\uFE0F Outstanding liability is $0.00 at this cutoff; such rows are discarded before training.")), showSummaries && /* @__PURE__ */ React.createElement("div", { className: "grid md:grid-cols-2 gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded border p-3" }, /* @__PURE__ */ React.createElement("div", { className: "text-xs font-medium text-gray-700 mb-2" }, "Near\u2011Static Covariates (latest up to cutoff)"), /* @__PURE__ */ React.createElement("div", { className: "overflow-auto border rounded mb-3 max-h-56" }, /* @__PURE__ */ React.createElement("table", { className: "w-full text-xs" }, /* @__PURE__ */ React.createElement("thead", { className: "bg-gray-50 sticky top-0" }, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { className: "px-2 py-2 text-left font-medium" }, "Dev Q"), /* @__PURE__ */ React.createElement("th", { className: "px-2 py-2 text-left font-medium" }, "Calendar Q"), /* @__PURE__ */ React.createElement("th", { className: "px-2 py-2 text-left font-medium" }, "Postcode"), /* @__PURE__ */ React.createElement("th", { className: "px-2 py-2 text-left font-medium" }, "Legal Rep"))), /* @__PURE__ */ React.createElement("tbody", null, devRange.map((dq, i) => {
    const q = byDev[dq];
