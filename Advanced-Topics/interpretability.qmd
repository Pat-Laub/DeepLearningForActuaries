...
An [Individual Conditional Expectation (ICE)](https://christophm.github.io/interpretable-ml-book/ice.html) plot is the same thing as a ceteris paribus plot, but for _each observation_ in the dataset.
...
print(watermark(python=True, packages="contextily,geopandas,keras,matplotlib,numpy,pandas,plotly,pygam,seaborn,scipy,shapely,sklearn,statsmodels,torch,tensorflow,tf_keras"))
```
