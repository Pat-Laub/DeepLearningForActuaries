...
::: {.content-visible unless-format="revealjs"}
If you find that someone else has fit a model to the same dataset, you can compare your metrics to theirs in your report. For example, [@kelley1997sparse] studied this dataset. You can compare the $R^2$ of their models to the ones we fit here.
:::
