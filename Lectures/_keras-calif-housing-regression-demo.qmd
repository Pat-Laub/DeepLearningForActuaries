...
:::
::: {.column width="30%"}
![Our use of sklearn.](images/scikit-learn-what-is-my-purpose.png)
:::
:::
...
::: {.content-visible unless-format="revealjs"}
You should have seen split A in your previous courses. In those courses, split A is used, and then cross-validation is performed to fit the hyperparameters. In the case of NNs, it much is more common to split the dataset into training, validation and test (split B). 
:::
