...
![Schematic of a recurrent neural network. E.g. SimpleRNN, LSTM, or GRU.](rnn-diagram.png)
...
![Categories of recurrent neural networks: sequence to sequence, sequence to vector, vector to sequence, encoder-decoder network.](rnn-types2.png)
...
![_Deep RNN_ unrolled through time.](rnn-stacked2.png)
