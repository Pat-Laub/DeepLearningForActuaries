...
__Next week__: Jacky Poon guest lecture on _Tuesday 13:00_.
...
# Project and StoryWall {background-image="unsw-yellow-shape.png" data-visibility="uncounted"}
...
## StoryWall #3 Stroke Prediction {.smaller}
...
print(f"The training set has shape {X_train_ct.shape} & there are now {numNANs} NANs in the data.")
```
...
::: footer
Sources: Aurélien Géron (2019), _Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow_, 2nd Edition, Figure 10-14 (__redacted__) & code snippet.
:::
...
preActivations = model.predict(X_train) 
...
Aurélien Géron (2019), _Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow_, Fig. 11-9 (__redacted__).
:::
...
::: footer
Source: Aurélien Géron (2019), _Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow_, 2nd Edition, Figure 7-1 (__redacted__).
:::
...
::: footer
Source: Aurélien Géron (2019), _Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow_, 2nd Edition, Figure 7-2 (__redacted__).
:::
...
# Preview of Recurrent Neural Networks {background-image="unsw-yellow-shape.png" data-visibility="uncounted"}
