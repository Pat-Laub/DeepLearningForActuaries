...
![An analogy for unconditional vs conditional GANs](unconditional-vs-conditional-generation.png)
...
![When the discriminator is too good, vanishing gradients](vanishing-gradients.png)
...
![Generating synthetic user information with _differential privacy_ and _Wasserstein GANs_.](wasserstein-schematic.png)
