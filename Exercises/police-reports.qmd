...
The data is available [here](https://github.com/JSchelldorfer/ActuarialDataScience/raw/master/12%20-%20NLP%20Using%20Transformers/NHTSA_NMVCCS_extract.parquet.gzip).
...
Make sure you don't include INJSEVA as in input to your models, as that is related to the target variable.
