...
3. Recompute the dispersion parameter using the adjusted model.
   Hint: use this code from the slides to get the means:
...
2. Change the distributional assumption from Gamma to [InverseGamma](https://pytorch.org/docs/stable/distributions.html#inversegamma).
   Hint: swap the component distribution in the loss function from the slides:
