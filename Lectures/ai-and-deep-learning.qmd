...
![A* algorithm (1968).](images/Astar_progress_animation.gif)
:::
:::
...
![The Venn diagram of Artificial Intelligence, Machine Learning, Neural Networks and Deep Learning. Adapted from [@shang2025artificial].](images/AI-vs-ML-vs-NN-vs-DeepLearning.png)
...
:::
::: {.column width="45%"}
![](images/xkcd-machine_learning_2x.png)
:::
:::
...
::: footer
Source: Krizhevsky, Sutskever and Hinton (2017), [_ImageNet Classification with Deep Convolutional Neural Networks_](https://doi.org/10.1145/3065386), Communications of the ACM 
:::
...
::: columns
::: column
![A GAN-generated face](images/thispersondoesnotexist1.jpg)
:::
::: column
![A GAN-generated face](images/thispersondoesnotexist2.jpg)
:::
:::
...
::: columns
::: column
![Dall-E 2](images/dalle-waterside-fail.png)
:::
::: column
![Dall-E 3](images/dalle-waterside.png)
:::
:::
...
::: columns
::: {.column width="50%"}
![AI predictions in the classification demo were from GPT code.](images/ChatGPT-4o-example.png)
:::
::: {.column width="50%"}
...
## Students get extra Copilot for free {.smaller}

::: columns
::: column
![Use a free trial then sign up for free education account](images/copilot__1_.png)
:::
::: column
...
![Question: What is your experience with the following AI tools?](images/jetbrains-2023-dev-survey-ai-tools.png)
...
::: columns
::: {.column width="33%"}
![Original image](images/inpainting-input.jpg)
:::
::: {.column width="33%"}
![Randomly remove a part](images/inpainting-missing.jpg)
:::
::: {.column width="33%"}
![Try to fill it in from context](images/inpainting-generative-fill.jpg)
:::
:::
...
:::
::: {.column width="45%"}
![](images/facial-recognition.jpeg)
![](images/modelling-ratio.png)
:::
:::
