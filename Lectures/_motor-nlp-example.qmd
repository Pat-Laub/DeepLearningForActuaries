...
if not Path("data/NHTSA_NMVCCS_extract.parquet.gzip").exists():                               #<2>
    ...
    !wget -P data https://github.com/JSchelldorfer/ActuarialDataScience/raw/master/12%20-%20NLP%20Using%20Transformers/NHTSA_NMVCCS_extract.parquet.gzip
                                                                                                #<3>
df = pd.read_parquet("data/NHTSA_NMVCCS_extract.parquet.gzip")                                       #<4>
...
nlp = spacy.load("en_core_web_trf")                                          #<2>
