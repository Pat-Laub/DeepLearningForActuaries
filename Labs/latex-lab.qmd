...
Unfortunately there isn't one standard Markdown syntax, but the most common one is [GitHub Flavored Markdown](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax). This is the syntax that Google Colab uses.
