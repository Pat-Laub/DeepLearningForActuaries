...
You need to install a few things to get Python running on your computer.
I've created a [sequence of recordings](https://www.youtube.com/playlist?list=PLKsJFg6SO0UilZFO_4dgFTf6jXkaomV6o) on how to get your tooling setup as a Python data scientist.
Some of the items in that playlist are recommended but not 100% necesary for this course, so I'll label those as optional in the list below:

1. Xcode developer tools (for Mac users, optional)
2. Homebrew (for Mac users, optional)
3. A python environment manager, either:
    1. uv (recommended)
    2. Anaconda (acceptable)
    3. Miniconda (a smaller Anaconda install)
4. Visual Studio Code

Apart from that, there are some resources there on setting up AI code completion tools (GitHub Copilot), but I recommend against using this for the course.
You'll learn better by hand-coding your models.
