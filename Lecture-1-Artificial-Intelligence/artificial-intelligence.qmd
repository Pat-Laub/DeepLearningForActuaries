...
![Illustration of minimax on a two-player game.](sebastian-lague-minimax.png)
...
{{< video https://youtu.be/WXuK6gekU1Y width="100%" height="70%" >}}
...
![The AI predictions in the earlier Image Classification demo were from GPT-generated code.](ChatGPT-4o-example.png)
...
::: footer
Cf. Liu et al. (2018), [Image Inpainting for Irregular Holes using Partial Convolutions](https://arxiv.org/pdf/1804.07723.pdf).
:::
