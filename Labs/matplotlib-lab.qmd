...
You should already have Matplotlib installed on your computer if you are using Python through Anaconda. It is also installed by default if you are using Google Colab. However if for some reason you don't have the library installed yet, you can do so using ```pip``` or ```conda```. 
...
```
Alternatively, you can open Anaconda Prompt and type in:
```
conda install matplotlib
```
You can also use the ```!pip3``` keyword to install it directly into your notebook, or install it using Anaconda Navigator.
