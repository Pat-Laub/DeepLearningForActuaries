# Example 2: Multiclass Classification {visibility="uncounted"}
...
![A basic network for classifying into three categories.](images/basic-classifier-network.png)
